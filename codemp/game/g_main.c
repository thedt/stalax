...
vmCvar_t	sta_flipkick;
vmCvar_t	sta_forcePlugin;
...
static cvarTable_t		gameCvarTable[] = {
	...
	{ &sta_flipkick, "sta_flipkick", "0", CVAR_ARCHIVE, 0, qfalse  },
	{ &sta_forcePlugin, "sta_forcePlugin", "0", CVAR_ARCHIVE, 0, qfalse  },
...
// nmckenzie: SABER_DAMAGE_WALLS
	...
	{ &sv_maxConnections,         "sv_maxConnections",         "0", CVAR_ARCHIVE | CVAR_INTERNAL, 0, qfalse },
...
// nmckenzie: DUEL_HEALTH: Default.
	...
	G_LuaCallInitEvent(levelTime, randomSeed, restart);
}
...
void G_ShutdownGame( int restart ) {
	...
	//[Stalax]
	G_LuaCallShutdownEvent(restart);
	G_Lua_Shutdown();
	//[/Stalax]
...
#define CLOAK_REFUEL_RATE		150 //seems fair
	...
	G_LuaCallFrameEvent(level.time);
}
