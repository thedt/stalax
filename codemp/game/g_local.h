...
#define	GAMEVERSION	"Stalax1.1-" SVN_REV
...
//Think Functions
	...
	st_lua_var_t		lua_vars[MAX_LUA_VARS];
	//[/Stalax]
...
// g_session.c
//
void G_ReadSessionData( gclient_t *client, qboolean firstTime, qboolean isBot );
...
extern	vmCvar_t	sta_flipkick;
extern	vmCvar_t	sta_forcePlugin;
